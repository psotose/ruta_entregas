...
class MapRoutesController < ApplicationController
  ...
  def create
    ...
    @error = ''
    valid = true
    # Manejo de errores en caso de inconsistencia principalmente en el archivo
    begin
      ...
      puts e
      @map_stops = []
      @error = 'Ocurrio un error inesperado, no es posible procesar su solicitud, vuelva a intentarlo'
    end
  end
